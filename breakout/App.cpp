    ...
    if (singleton->moving){
        ...
        if (singleton->platform->contains(bx, by)){
            ...
            if(singleton->layout.contains(bx,by)) {
                ...
                if(singleton->layout.getfile() == "images/silver.png") {
...
App::App(const char* label, int x, int y, int w, int h): GlutApp(label, x, y, w, h){
    ...
    ball = new TexRect("images/spiked_ball.png", 0, 0, 0.09, 0.09);

    platform = new TexRect("images/board.png", 0, -0.7, 0.45, 0.15);
